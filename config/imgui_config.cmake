...
if (IMGUI_DISABLE_DEMO_WINDOWS)
    target_compile_definitions(${PROJECT_NAME} PUBLIC IMGUI_DISABLE_DEMO_WINDOWS)
endif()

if (IMGUI_DISABLE_DEBUG_TOOLS)
    target_compile_definitions(${PROJECT_NAME} PUBLIC IMGUI_DISABLE_DEBUG_TOOLS)
endif()

if (IMGUI_DISABLE_WIN32_FUNCTIONS)
    target_compile_definitions(${PROJECT_NAME} PUBLIC IMGUI_DISABLE_WIN32_FUNCTIONS)
endif()

if (IMGUI_ENABLE_FREETYPE_LUNASVG)
    CPMAddPackage("gh:sammycage/lunasvg#d1eec96")
...
if (IMGUI_DEBUG_PARANOID)
    target_compile_definitions(${PROJECT_NAME} PUBLIC IMGUI_DEBUG_PARANOID)
endif()
